...
public class HomeController {
	...
	public ModelAndView search(@RequestParam String searchitems)
	{
		
		ModelAndView mv = new ModelAndView();
		mv.setViewName("home");
		List<Product> searchproduct=productDAO.search(searchitems);
		mv.addObject("productlist", searchproduct);
		mv.addObject("isUserSearchProducts",true);
		return mv;
